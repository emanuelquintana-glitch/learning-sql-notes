...
-- Versión compatible con DuckDB
-- ============================================================
--
-- DIFERENCIAS vs SQLite:
--   • Sin PRAGMA (DuckDB no los soporta)
--   • Sin SET defer_foreign_keys (DuckDB no lo soporta)
--   • Employee se inserta fila a fila en orden de dependencia
--     para respetar la FK self-referencial (superior_emp_id)
-- ============================================================
...
-- Empleados
-- La tabla tiene una FK self-referencial: superior_emp_id → emp_id.
-- DuckDB verifica cada fila al insertarla, por lo que hay que insertar
-- en orden: primero el nodo raíz (superior = NULL), luego sus subordinados.
...
-- Nivel 0 – sin superior
INSERT INTO employee VALUES (1,'Michael','Smith','2001-06-22',NULL,NULL,3,'President',1);
-- Nivel 1 – reportan a emp 1
INSERT INTO employee VALUES (2,'Susan','Barker','2002-09-12',NULL,1,3,'Vice President',1);
INSERT INTO employee VALUES (3,'Robert','Tyler','2000-02-09',NULL,1,3,'Treasurer',1);
-- Nivel 2 – reportan a emp 3
INSERT INTO employee VALUES (4,'Susan','Hawthorne','2002-04-24',NULL,3,1,'Operations Manager',1);
-- Nivel 3 – reportan a emp 4
INSERT INTO employee VALUES (5,'John','Gooding','2003-11-14',NULL,4,2,'Loan Manager',1);
INSERT INTO employee VALUES (6,'Helen','Fleming','2004-03-17',NULL,4,1,'Head Teller',1);
INSERT INTO employee VALUES (10,'Paula','Roberts','2002-07-27',NULL,4,1,'Head Teller',2);
INSERT INTO employee VALUES (13,'John','Blake','2000-05-11',NULL,4,1,'Head Teller',3);
INSERT INTO employee VALUES (16,'Theresa','Markham','2001-03-15',NULL,4,1,'Head Teller',4);
-- Nivel 4 – reportan a emp 6
INSERT INTO employee VALUES (7,'Chris','Tucker','2004-09-15',NULL,6,1,'Teller',1);
INSERT INTO employee VALUES (8,'Sarah','Parker','2002-12-02',NULL,6,1,'Teller',1);
INSERT INTO employee VALUES (9,'Jane','Grossman','2002-05-03',NULL,6,1,'Teller',1);
-- Nivel 4 – reportan a emp 10
INSERT INTO employee VALUES (11,'Thomas','Ziegler','2000-10-23',NULL,10,1,'Teller',2);
INSERT INTO employee VALUES (12,'Samantha','Jameson','2003-01-08',NULL,10,1,'Teller',2);
-- Nivel 4 – reportan a emp 13
INSERT INTO employee VALUES (14,'Cindy','Mason','2002-08-09',NULL,13,1,'Teller',3);
INSERT INTO employee VALUES (15,'Frank','Portman','2003-04-01',NULL,13,1,'Teller',3);
-- Nivel 4 – reportan a emp 16
INSERT INTO employee VALUES (17,'Beth','Fowler','2002-06-29',NULL,16,1,'Teller',4);
INSERT INTO employee VALUES (18,'Rick','Tulman','2002-12-12',NULL,16,1,'Teller',4);
...
CREATE TABLE IF NOT EXISTS acc_transaction (
    ...
    txn_type_cd         VARCHAR,   -- 'DBT' débito, 'CDT' crédito
    amount              DECIMAL(10,2),
